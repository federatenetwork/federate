...
23 official TLDs (`.fed`, `.busca`, `.pagina`, `.pages`, `.cara`, `.comu`, `.oi`, `.weblog`, `.rosa`, `.mosca`, `.tipos`, `.types`, `.foto`, `.pic`, `.vid`, `.sound`, `.records`, and six color namespaces), defined in `federate-naming`.
